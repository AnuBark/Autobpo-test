...
// ========================================================================
// FINAL – All entities, DbContext, repositories, event bus, outbox.
// ========================================================================
...
namespace DigitalCoFounder.BPO
{
    ...
    // LearningPath, PortfolioItem, UserPortfolio, LiveEvent, SubscriptionPlan, UserSubscription
    ...
    // AppDbContext (without global tenant filter)
    ...
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public Repository(AppDbContext context, ITenantContext tenantContext) { _context = context; _tenantId = tenantContext.CurrentTenantId; }
        ...
        public async Task<T> GetByIdAsync(int id) => await Query().FirstOrDefaultAsync(e => EF.Property<int>(e, "Id") == id);
        public async Task<IEnumerable<T>> GetAllAsync() => await Query().ToListAsync();
        public async Task AddAsync(T entity) => await _context.Set<T>().AddAsync(entity);
        public async Task UpdateAsync(T entity) { _context.Entry(entity).State = EntityState.Modified; await Task.CompletedTask; }
        public void Delete(T entity) => _context.Set<T>().Remove(entity);
    }

    // RefreshTokenService, RabbitMQEventBus, EventOutboxService, LoggedBackgroundService
