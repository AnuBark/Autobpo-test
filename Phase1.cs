...
// ========================================================================
// FINAL PATCHED: All fixes applied, TenantId added to missing entities.
// ========================================================================
...
namespace DigitalCoFounder.BPO
{
    ...
    public enum ServiceType { BPO, KPO_Analytics, KPO_Legal, KPO_RnD, KPO_ESG, Offshore_India, Offshore_Philippines, Offshore_China, Hybrid_GCC }
    public enum WorkType { AI_Self, Outsourced }
    public enum DisputeStatus { None, RaisedByClient, RaisedByDeveloper, Resolved, Escalated }
    ...
    // Config Class (full with Grey.co + PayFast)
    public class Config
    {
    ...
    public class Project : AggregateRoot
    {
        ...
        private void RecalculateCommission(Config config)
        {
            PlatformCommission = TotalPrice * config.PlatformCommissionRate;
        }
    ...
    // New Business Layer Entities (with TenantId added)
    ...
    {
        public int Id { get; set; }
        public string TenantId { get; set; } = "system";  // Added
    ...
    public class AppDbContext : DbContext
    {
        ...
        // No-op method for compatibility (global filter removed)
    ...
    // Repository & Unit of Work (clean version)
    ...
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public IQueryable<T> Query(bool ignoreTenantFilter = false)
        {
            ...
            return query.Where(e => EF.Property<string>(e, "TenantId") == _tenantId);
        }

        public IQueryable<T> QueryNoTracking(bool ignoreTenantFilter = false)
            => Query(ignoreTenantFilter).AsNoTracking();
    ...
    public class EventOutboxService : BackgroundService
    {
        ...
        public EventOutboxService(IServiceScopeFactory scopeFactory, ILogger<EventOutboxService> logger)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    var pending = await db.EventStoreEntries
                        .Where(e => !e.Processed && e.Retries < 5)
